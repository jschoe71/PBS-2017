...
%The birefringence causes H- and V-polarized lights hav
...
%If the lower arm of the MZI provides phase difference of 90$^\circ$ between the two arms for both the polarizations, is designed so that phase difference of 90$^\circ$ occurs between the two input ports of the MMI for both the polarizations, the polarization of each polarization will only come out to different output ports of the MMI due to the nature of the MMI.
